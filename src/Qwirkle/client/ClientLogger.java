...
public class ClientLogger extends Logger {
    ...
    public static final String SETUP_FAILED = "Failed to start client, check if server is running and if host and port are correct";
    public static final String NO_SSL = "It appears the server does not support SSL. Please use a regular socket connection";
    ...
    public static final String NAME_TOO_LONG = "Name that was provided is too long, has been cut off at 15 characters";
    public static final String NOT_CHALLENGABLE = "Player you challenged was not able to respond to your challenge...";
    public static final String WAITING = "Waiting...";
    public static final String SEARCHING_GAME = "Busy looking for a matching game...";
    public static final String USERNAME_EXISTS = "Username already exists, please reconnect with a different name";
