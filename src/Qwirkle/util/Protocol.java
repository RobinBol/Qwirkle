 ...
 * <p>
 * <p>In dit bestand staat het protocol van werkgroep 4 zoals dat op woensdag.6 januari is
 * afgesproken. </p>
 ...
 * <p>
 * <p>Voor communicatie tussen de server en de client is er gekozen voor een Printstream, dit is
 * een voorlopige keuze sinds we dit niet tijdens de sessie hebben besproken</p>
 * <p>
 * <ul>
 * <li> Hoewel er tijdens de protocolsessie geen afspraken zijn gemaakt over wat voor stream er
 * gebruikt gaat worden is er voor deze gekozen.</li>
 ...
 * <p>De origin van het bordt staat op 0,0 , waar de eerste waarde de colom bijhoudt en de tweede
 * de rij</p>
 * <p>
 ...
 * <p>
 * <p>
 * <p>Vanwege gebruiksgemak en het vergemakkelijken van het renderen heb ik besloten om de
 * maximale lengte van de naam van een player op 15 karakters te zetten. Dit is in de meeste, zo
 * niet alle, gevallen wel genoeg, en zal door de maximale lengte ook geen problemen meer
 * opleveren door veel te lange usernames in bijvoorbeeld de chat.</p>
 * <p>
 * <p>Punt van aandacht bij het programmeren: Players <strong>moeten</strong> een unieke naam
 * hebben: De naam wordt veel gebruikt voor identificatie.</p>
 * <p>
 * <p>
 ...
 * <p>
 * <p> er zijn verschillende errorcodes, heb je een goede reden om een extra aan te vragen gooi
 * het over de github  </p>
 * <p>
 * <p>
 ...
 * <p>
 * <p>Als delimiter tussen argumenten gebruiken wij een underscore (<code>_<\code>) omdat dit
 * makkelijk en handig is.</p>
 * <p>Als delimiter binnen een argument gebruiken wij een sterretje (<code>*<\code>) omdat dit
 * makkelijk en handig is.</p>
 * <p>
 * <p>
 * <p>
 ...
 * <p>
 * <p>Hierop volgt een lijst met overeengekomen commando's. Deze zijn gesorteerd op type en waar
 * ze geimplementeerd moeten zijn. </p>
 * <p>
...
public class Protocol {
    public static class Client {
         ...
         * Descriptie: Packet dat verzonden wordt om een spel te starten met de aangegeven
         * tegenstander. <br>
         * Content: <code>&lt;Opponent Name&gt;</code>  [<code>&lt;BoardX&gt;</code> <code>&lt;
         * BoardY&gt;</code> [<code>&lt;Settings&gt;</code>]]</p>
         * <p>
         * <ul>
         * <li><code>Opponent Name</code>: <code>String</code> (15) - De naam van de speler die
         * de invite moet ontvangen.</li>
         */
         ...
         * <p>Accept Invite <br>
         * Name: <code>ACCEPT\n\n</code> <br>
         * Descriptie: Packet door de uitgedaagde partij wordt verzonden om op een invite in te
         * gaan. <br>
         * Content: <code>&lt;Opponent Name&gt;</code></p>
         * <p>
         * <ul>
         * <li><code>Opponent Name</code>: <code>String</code> (15) - De naam van degene die de
         * uitgedaagde partij heeft uitgedaagd.</li>
         * </ul>
         */
         ...
         * <p>Decline Invite <br>
         * Name: <code>DECLINE\n\n</code> <br>
         * Descriptie: Packet die door de uitgedaagde partij wordt verzonden om een invite af te
         * slaan. <br>
         * Content: <code>&lt;Opponent Name&gt;</code></p>
         * <p>
         * <ul>
    ...
    public static class Server {
         ...
         * <p>HALLO <br>
         * Name: <code>HALLO</code> <br>
         * Descriptie: Signaal dat de connectie is gemaakt en het aangeven van welke functies
         * allemaal zijn toegestaan op deze server. <br>
         ...
         * <ul>
         * <li><code>Error Code</code>: <code>String</code> - De code is de header van het
         * bericht waar de fout door is ontstaan. </li>
         * <li><code>Message</code>: <code>String</code> (255) - Het bericht dat je aan je error
         * hangt. Hierin kan je extra info tonen over wat er precies is foutgegaan.</li>
         * </ul>
         * <p>
         ...
         * Descriptie: Geeft met de integer aan op hoeveel mensen de speler nog moet wachten tot
         * het spel begint <br>
         ...
         * Descriptie: Een packet dat naar de spelers wordt gestuurd om te laten weten dat het
         * spel gestart is. <br>
         ...
         * <li><code>Winner Name</code>: <code>String</code> (15) - Naam van de winnaar, of
         * andere info over de reden van het einde.</li>
         * </ul>
         */
         ...
         * Descriptie: een commando om aan te geven welke move gemaakt door wie en welke speler
         * nu aan de beurt is <br>
         ...
         * <p>Leaderboard <br>
         * Name: <code>LEADERBOARD</code> <br>
         * Descriptie: Een packet waarin de statistieken van een aantal spelers worden verstuurd.
         * <br>
         * Content: <code>LEADERBOARD_playername*integer_playername*integer\n\n</code></p>
         * <p>
         * <ul>
         * <li><code>Player Name</code>: <code>String</code> (15) - Naam van de speler in de
         * betreffende statistiek</li>
        ...
        public static class Features {
            ...
            public static final String CHALLENGE = "CHALLENGE"; // Deze functie wordt nog niet
            // verwacht wordt dat SSLsocket gebruikt gaat worden
        }
         ...
         * <p>
         * <ul>
         * <li><code>Opponent Name</code>: <code>String</code> (15) - De naam van de
         * tegenstander</li>
         * </ul>
        ...
        public static class Settings {
            ...
            /**
             * <p>Het protocol heeft characterencoding UTF-16. Dit is de standaard encoding van
             * een string in java, dus daar zouden geen problemen mee moeten zijn.</p>
             */

            public static final String ENCODING = "UTF-16";

            /**
             * <p>Het aantal seconden voordat een client timeout. Dit is in de opdracht
             * vastgesteld, en zal dus niet veranderen.</p>
             */
             ...
             * <b>BELANGRIJK:</b> In de opdracht staat dat je bij het opstarten van de server een
             * poortnummer moet invoeren. De waarde hier is dus niet een waarde die altijd opgaat
             * . </p>
             */
            ...
            /**
             * <p>Default delimiter tussen header en content, en tussen twee waarden in de
             * content</p>
             */

            public static final char DELIMITER = '_';
            /**
             * <p>tweede delimiter om zaken te scheiden binenin een waarde in de content
             * (bijvoorbeeld bij een steen locatie waarde)</p>
             */
            public static final char DELIMITER2 = '*';
            /**
             * <p>Teken dat aan het einde van elke packet moet zitten, en dus niet in de rest van
             * de waarden mag zitten.</p>
             */
